...
type ClientAuthenticationRequest struct {
	...
	ClientAssertionType *wrapperspb.StringValue `protobuf:"bytes,3,opt,name=client_assertion_type,json=clientAssertionType,proto3" json:"client_assertion_type,omitempty"`
	ClientAssertion     *wrapperspb.StringValue `protobuf:"bytes,4,opt,name=client_assertion,json=clientAssertion,proto3" json:"client_assertion,omitempty"`
}
...
func (x *ClientAuthenticationRequest) GetClientId() *wrapperspb.StringValue {
	if x != nil {
		return x.ClientId
	}
	return nil
...
func (x *ClientAuthenticationRequest) GetClientSecret() *wrapperspb.StringValue {
	if x != nil {
...
func (x *ClientAuthenticationRequest) GetClientAssertionType() *wrapperspb.StringValue {
	if x != nil {
...
func (x *ClientAuthenticationRequest) GetClientAssertion() *wrapperspb.StringValue {
	if x != nil {
