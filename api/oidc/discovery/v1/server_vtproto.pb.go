...
func (m *ServerMetadata) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.AuthorizationDetailsTypesSupported) > 0 {
		for iNdEx := len(m.AuthorizationDetailsTypesSupported) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.AuthorizationDetailsTypesSupported[iNdEx])
			copy(dAtA[i:], m.AuthorizationDetailsTypesSupported[iNdEx])
			i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.AuthorizationDetailsTypesSupported[iNdEx])))
			i--
			dAtA[i] = 0x3
			i--
			dAtA[i] = 0xd2
	...
	if len(m.SignedMetadata) > 0 {
		...
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.SignedMetadata)))
		i--
		dAtA[i] = 0x3
		i--
		dAtA[i] = 0xc2
	...
	if len(m.IntrospectionEncryptionEncValuesSupported) > 0 {
		for iNdEx := len(m.IntrospectionEncryptionEncValuesSupported) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.IntrospectionEncryptionEncValuesSupported[iNdEx])))
			i--
			dAtA[i] = 0x3
			i--
			dAtA[i] = 0xba
	...
	if len(m.IntrospectionEncryptionAlgValuesSupported) > 0 {
		for iNdEx := len(m.IntrospectionEncryptionAlgValuesSupported) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.IntrospectionEncryptionAlgValuesSupported[iNdEx])))
			i--
			dAtA[i] = 0x3
			i--
			dAtA[i] = 0xb2
	...
	if len(m.IntrospectionSigningAlgValuesSupported) > 0 {
		for iNdEx := len(m.IntrospectionSigningAlgValuesSupported) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.IntrospectionSigningAlgValuesSupported[iNdEx])))
			i--
			dAtA[i] = 0x3
			i--
			dAtA[i] = 0xaa
	...
	if len(m.AuthorizationEncryptionEncValuesSupported) > 0 {
		for iNdEx := len(m.AuthorizationEncryptionEncValuesSupported) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.AuthorizationEncryptionEncValuesSupported[iNdEx])))
			i--
			dAtA[i] = 0x3
			i--
			dAtA[i] = 0x9a
	...
	if len(m.AuthorizationEncryptionAlgValuesSupported) > 0 {
		for iNdEx := len(m.AuthorizationEncryptionAlgValuesSupported) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.AuthorizationEncryptionAlgValuesSupported[iNdEx])))
			i--
			dAtA[i] = 0x3
			i--
			dAtA[i] = 0x92
	...
	if len(m.AuthorizationSigningAlgValuesSupported) > 0 {
		for iNdEx := len(m.AuthorizationSigningAlgValuesSupported) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.AuthorizationSigningAlgValuesSupported[iNdEx])))
			i--
			dAtA[i] = 0x3
			i--
			dAtA[i] = 0x8a
	...
	if len(m.DpopSigningAlgValuesSupported) > 0 {
		for iNdEx := len(m.DpopSigningAlgValuesSupported) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.DpopSigningAlgValuesSupported[iNdEx])))
			i--
			dAtA[i] = 0x2
			i--
			dAtA[i] = 0xfa
	...
	if len(m.DeviceAuthorizationEndpoint) > 0 {
		...
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.DeviceAuthorizationEndpoint)))
		i--
		dAtA[i] = 0x2
		i--
		dAtA[i] = 0xf2
	...
	if len(m.PushedAuthorizationRequestEndpointAuthMethodsSupported) > 0 {
		for iNdEx := len(m.PushedAuthorizationRequestEndpointAuthMethodsSupported) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.PushedAuthorizationRequestEndpointAuthMethodsSupported[iNdEx])))
			i--
			dAtA[i] = 0x2
			i--
			dAtA[i] = 0xe2
	...
	if len(m.PushedAuthorizationRequestEndpoint) > 0 {
		...
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.PushedAuthorizationRequestEndpoint)))
		i--
		dAtA[i] = 0x2
		i--
		dAtA[i] = 0xda
	...
	if len(m.CodeChallengeMethodsSupported) > 0 {
		for iNdEx := len(m.CodeChallengeMethodsSupported) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.CodeChallengeMethodsSupported[iNdEx])))
			i--
			dAtA[i] = 0x2
			i--
			dAtA[i] = 0xd2
	...
	if len(m.IntrospectionEndpointAuthSigningAlgValuesSupported) > 0 {
		for iNdEx := len(m.IntrospectionEndpointAuthSigningAlgValuesSupported) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.IntrospectionEndpointAuthSigningAlgValuesSupported[iNdEx])))
			i--
			dAtA[i] = 0x2
			i--
			dAtA[i] = 0xca
	...
	if len(m.IntrospectionEndpointAuthMethodsSupported) > 0 {
		for iNdEx := len(m.IntrospectionEndpointAuthMethodsSupported) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.IntrospectionEndpointAuthMethodsSupported[iNdEx])))
			i--
			dAtA[i] = 0x2
			i--
			dAtA[i] = 0xc2
	...
	if len(m.IntrospectionEndpoint) > 0 {
		...
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.IntrospectionEndpoint)))
		i--
		dAtA[i] = 0x2
		i--
		dAtA[i] = 0xba
	...
	if len(m.RevocationEndpointAuthSigningAlgValuesSupported) > 0 {
		for iNdEx := len(m.RevocationEndpointAuthSigningAlgValuesSupported) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.RevocationEndpointAuthSigningAlgValuesSupported[iNdEx])))
			i--
			dAtA[i] = 0x2
			i--
			dAtA[i] = 0xb2
	...
	if len(m.RevocationEndpointAuthMethodsSupported) > 0 {
		for iNdEx := len(m.RevocationEndpointAuthMethodsSupported) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.RevocationEndpointAuthMethodsSupported[iNdEx])))
			i--
			dAtA[i] = 0x2
			i--
			dAtA[i] = 0xaa
	...
	if len(m.RevocationEndpoint) > 0 {
		...
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.RevocationEndpoint)))
		i--
		dAtA[i] = 0x2
		i--
		dAtA[i] = 0xa2
	...
	if len(m.OpTosUri) > 0 {
		...
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.OpTosUri)))
		i--
		dAtA[i] = 0x2
		i--
		dAtA[i] = 0x9a
	...
	if len(m.OpPolicyUri) > 0 {
		...
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.OpPolicyUri)))
		i--
		dAtA[i] = 0x2
		i--
		dAtA[i] = 0x92
	...
	if len(m.UiLocalesSupported) > 0 {
		for iNdEx := len(m.UiLocalesSupported) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.UiLocalesSupported[iNdEx])))
			i--
			dAtA[i] = 0x1
			i--
			dAtA[i] = 0xea
	...
	if len(m.ClaimsLocalesSupported) > 0 {
		for iNdEx := len(m.ClaimsLocalesSupported) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.ClaimsLocalesSupported[iNdEx])))
			i--
			dAtA[i] = 0x1
			i--
			dAtA[i] = 0xe2
	...
	if len(m.ServiceDocumentation) > 0 {
		...
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.ServiceDocumentation)))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xda
	...
	if len(m.ClaimsSupported) > 0 {
		for iNdEx := len(m.ClaimsSupported) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.ClaimsSupported[iNdEx])))
			i--
			dAtA[i] = 0x1
			i--
			dAtA[i] = 0xd2
	...
	if len(m.ClaimTypesSupported) > 0 {
		for iNdEx := len(m.ClaimTypesSupported) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.ClaimTypesSupported[iNdEx])))
			i--
			dAtA[i] = 0x1
			i--
			dAtA[i] = 0xca
	...
	if len(m.DisplayValuesSupported) > 0 {
		for iNdEx := len(m.DisplayValuesSupported) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.DisplayValuesSupported[iNdEx])))
			i--
			dAtA[i] = 0x1
			i--
			dAtA[i] = 0xc2
	...
	if len(m.TokenEndpointAuthSigningAlgValuesSupported) > 0 {
		for iNdEx := len(m.TokenEndpointAuthSigningAlgValuesSupported) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.TokenEndpointAuthSigningAlgValuesSupported[iNdEx])))
			i--
			dAtA[i] = 0x1
			i--
			dAtA[i] = 0xba
	...
	if len(m.TokenEndpointAuthMethodsSupported) > 0 {
		for iNdEx := len(m.TokenEndpointAuthMethodsSupported) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.TokenEndpointAuthMethodsSupported[iNdEx])))
			i--
			dAtA[i] = 0x1
			i--
			dAtA[i] = 0xb2
	...
	if len(m.RequestObjectEncryptionEncValuesSupported) > 0 {
		for iNdEx := len(m.RequestObjectEncryptionEncValuesSupported) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.RequestObjectEncryptionEncValuesSupported[iNdEx])))
			i--
			dAtA[i] = 0x1
			i--
			dAtA[i] = 0xaa
	...
	if len(m.RequestObjectEncryptionAlgValuesSupported) > 0 {
		for iNdEx := len(m.RequestObjectEncryptionAlgValuesSupported) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.RequestObjectEncryptionAlgValuesSupported[iNdEx])))
			i--
			dAtA[i] = 0x1
			i--
			dAtA[i] = 0xa2
	...
	if len(m.RequestObjectSigningAlgValuesSupported) > 0 {
		for iNdEx := len(m.RequestObjectSigningAlgValuesSupported) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.RequestObjectSigningAlgValuesSupported[iNdEx])))
			i--
			dAtA[i] = 0x1
			i--
			dAtA[i] = 0x9a
	...
	if len(m.UserinfoEncryptionEncValuesSupported) > 0 {
		for iNdEx := len(m.UserinfoEncryptionEncValuesSupported) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.UserinfoEncryptionEncValuesSupported[iNdEx])))
			i--
			dAtA[i] = 0x1
			i--
			dAtA[i] = 0x92
	...
	if len(m.UserinfoEncryptionAlgValuesSupported) > 0 {
		for iNdEx := len(m.UserinfoEncryptionAlgValuesSupported) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.UserinfoEncryptionAlgValuesSupported[iNdEx])))
			i--
			dAtA[i] = 0x1
			i--
			dAtA[i] = 0x8a
	...
	if len(m.UserinfoSigningAlgValuesSupported) > 0 {
		for iNdEx := len(m.UserinfoSigningAlgValuesSupported) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.UserinfoSigningAlgValuesSupported[iNdEx])))
			i--
			dAtA[i] = 0x1
			i--
			dAtA[i] = 0x82
	...
	if len(m.IdTokenEncryptionEncValuesSupported) > 0 {
		for iNdEx := len(m.IdTokenEncryptionEncValuesSupported) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.IdTokenEncryptionEncValuesSupported[iNdEx])))
			i--
			dAtA[i] = 0x7a
		}
	}
	if len(m.IdTokenEncryptionAlgValuesSupported) > 0 {
		for iNdEx := len(m.IdTokenEncryptionAlgValuesSupported) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.IdTokenEncryptionAlgValuesSupported[iNdEx])))
			i--
			dAtA[i] = 0x72
		}
	}
	if len(m.IdTokenSigningAlgValuesSupported) > 0 {
		for iNdEx := len(m.IdTokenSigningAlgValuesSupported) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.IdTokenSigningAlgValuesSupported[iNdEx])))
			i--
			dAtA[i] = 0x6a
		}
	}
	if len(m.SubjectTypesSupported) > 0 {
		for iNdEx := len(m.SubjectTypesSupported) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.SubjectTypesSupported[iNdEx])))
			i--
			dAtA[i] = 0x62
		}
	}
	if len(m.AcrValuesSupported) > 0 {
		for iNdEx := len(m.AcrValuesSupported) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.AcrValuesSupported[iNdEx])))
			i--
			dAtA[i] = 0x5a
		}
	}
	if len(m.GrantTypesSupported) > 0 {
		for iNdEx := len(m.GrantTypesSupported) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.GrantTypesSupported[iNdEx])))
			i--
			dAtA[i] = 0x52
		}
	}
	if len(m.ResponseModesSupported) > 0 {
		for iNdEx := len(m.ResponseModesSupported) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.ResponseModesSupported[iNdEx])))
			i--
			dAtA[i] = 0x4a
		}
	}
	if len(m.ResponseTypesSupported) > 0 {
		for iNdEx := len(m.ResponseTypesSupported) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.ResponseTypesSupported[iNdEx])))
			i--
			dAtA[i] = 0x42
		}
	}
	if len(m.ScopesSupported) > 0 {
		for iNdEx := len(m.ScopesSupported) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.ScopesSupported[iNdEx])))
			i--
			dAtA[i] = 0x3a
		}
	}
	if len(m.RegistrationEndpoint) > 0 {
		...
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.RegistrationEndpoint)))
		i--
		dAtA[i] = 0x32
	}
	if len(m.UserinfoEndpoint) > 0 {
		...
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.UserinfoEndpoint)))
		i--
		dAtA[i] = 0x2a
	}
	if len(m.JwksUri) > 0 {
...
func (m *ServerMetadata) SizeVT() (n int) {
	...
	if len(m.AuthorizationDetailsTypesSupported) > 0 {
		for _, s := range m.AuthorizationDetailsTypesSupported {
			l = len(s)
			n += 2 + l + protohelpers.SizeOfVarint(uint64(l))
		}
	}
...
func (m *ServerMetadata) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 57:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ClientIdMetadataDocumentSupported", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ClientIdMetadataDocumentSupported = bool(v != 0)
		case 58:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AuthorizationDetailsTypesSupported", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.AuthorizationDetailsTypesSupported = append(m.AuthorizationDetailsTypesSupported, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
