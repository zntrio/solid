...
func (c *clientAuthenticationServiceClient) Authenticate(ctx context.Context, in *AuthenticateRequest, opts ...grpc.CallOption) (*AuthenticateResponse, error) {
	...
	err := c.cc.Invoke(ctx, ClientAuthenticationService_Authenticate_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedClientAuthenticationServiceServer should be embedded to have
...
func (UnimplementedClientAuthenticationServiceServer) testEmbeddedByValue() {}
...
func RegisterClientAuthenticationServiceServer(s grpc.ServiceRegistrar, srv ClientAuthenticationServiceServer) {
	// If the following call panics, it indicates UnimplementedClientAuthenticationServiceServer was
...
func (c *clientRegistrationServiceClient) Register(ctx context.Context, in *RegisterRequest, opts ...grpc.CallOption) (*RegisterResponse, error) {
	...
	err := c.cc.Invoke(ctx, ClientRegistrationService_Register_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedClientRegistrationServiceServer should be embedded to have
// forward compatible implementations.
//
// NOTE: this should be embedded by value instead of pointer to avoid a nil
// pointer dereference when methods are called.
...
func (UnimplementedClientRegistrationServiceServer) testEmbeddedByValue() {}
...
func RegisterClientRegistrationServiceServer(s grpc.ServiceRegistrar, srv ClientRegistrationServiceServer) {
	// If the following call panics, it indicates UnimplementedClientRegistrationServiceServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
