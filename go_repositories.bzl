...
def go_repositories():
    ...
    go_repository(
        ...
        sum = "h1:kttPCLzXFa+0nt++Cw9fb7GrSSM4KkyIAoX/vXsbuqA=",
        version = "v0.6.1",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:w7QXnpH0eCBJm55zGCTJveZEkQBt6Fs5zThIdA6qQ9Y=",
        version = "v0.2.2",
    )
    go_repository(
        name = "com_github_breml_errchkjson",
        importpath = "github.com/breml/errchkjson",
        sum = "h1:97eGTmR/w0paL2SwfRPI1jaAZHaH/fXnxWTw2eEIqE0=",
        version = "v0.2.3",
    )
    ...
    go_repository(
        ...
        sum = "h1:IykTnjwh2YLyYkGa0y92iTTEQcnyAz0r9zOo15EbJ7k=",
        version = "v0.4.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:L5SDut1N4ZfsWZY0sH4DCrsHLHnhuuWak2wa165t9gs=",
        version = "v0.6.2",
    )
    ...
    go_repository(
        ...
        sum = "h1:9I3PzkvscJkFAQpTQi5Ga0V4qWdJERajX1UZ7QqkW+I=",
        version = "v1.45.2",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:Uf4CUekH0OvzQTFPrWkstJvXgm6pnNEtQu3HiqEkpB0=",
        version = "v0.5.1",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:sZOjY6GU35Kr9jKa/wsKSHgrFz8eASIB5i3tqWZMp0A=",
        version = "v1.1.4",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:iWYzp1z72IlXTioET0+XI6SjQdPfMGfuAiZiKznOt7g=",
        version = "v0.3.15",
    )
    go_repository(
        name = "com_github_quasilyte_go_ruleguard_dsl",
        importpath = "github.com/quasilyte/go-ruleguard/dsl",
        sum = "h1:L5xf3nifnRIdYe9vyMuY2sDnZHIgQol/fDq74FQz7ZY=",
        version = "v0.3.17",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:P4QPNn+TK49zJjXKERt/vyPbv/mCHB/zQ4flDYOMN+M=",
        version = "v0.0.0-20220103110004-ffaa07af02e3",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:l6BET4EzWtyUXCpY2v7N92v0DDCas0L7ngg3bpqbr8g=",
        version = "v2.10.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:wCrArWFkHYIdDxx/FSfF5RB4dpJYW6t7rcp3+zL8uks=",
        version = "v3.22.2",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:g27SGGHNoQdvHz4KZA9o4v09RcWzylR+b1yueE5ECiw=",
        version = "v2.5.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:YAaOqqMTstELMMGblt6yJ/fcOt4owSYuw3IttMnKfAM=",
        version = "v0.1.1-0.20210918184747-d757024714a1",
    )
    go_repository(
    ...
    go_repository(
        name = "io_zntr_paseto",
        importpath = "zntr.io/paseto",
        sum = "h1:vob039eJ9Z6sCVuMRRaioXi+IdMTR/VpwWCxr6LqB/s=",
        version = "v1.1.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:NvGWuYG8dkDHFSKksI1P9faiVJ9rayE6l0+ouWVIDs8=",
        version = "v0.0.0-20220507011949-2cf3adece122",
    )
    go_repository(
    ...
    go_repository(
        name = "org_mozilla_go_cose",
        importpath = "go.mozilla.org/cose",
        sum = "h1:KQFism670YpZ/yv6AZbAaRbl9BLeQf3D10xgnfuPbDQ=",
        version = "v0.0.0-20200930124131-25dc96df8228",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:ltj5KWhbQjt1Yx+IPBj0Dk2HVDUs9OlLmGC2JvivTMo=",
        version = "v1.8.0",
    )
    go_repository(
