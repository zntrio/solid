...
//go:generate mockgen -destination mock/client.gen.go -package mock zntr.io/solid/server/profile Client
...
//go:generate mockgen -destination mock/server.gen.go -package mock zntr.io/solid/server/profile Server
