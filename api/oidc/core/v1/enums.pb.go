...
const file_oidc_core_v1_enums_proto_rawDesc = "" +
	"\n" +
	"\x18oidc/core/v1/enums.proto\x12\foidc.core.v1*\x80\x01\n" +
	"\aDisplay\x12\x17\n" +
	"\x13DISPLAY_UNSPECIFIED\x10\x00\x12\x13\n" +
	"\x0fDISPLAY_UNKNOWN\x10\x01\x12\x10\n" +
	"\fDISPLAY_PAGE\x10\x02\x12\x11\n" +
	"\rDISPLAY_POPUP\x10\x03\x12\x11\n" +
	"\rDISPLAY_TOUCH\x10\x04\x12\x0f\n" +
	"\vDISPLAY_WAP\x10\x05*\x86\x01\n" +
	"\x06Prompt\x12\x16\n" +
	"\x12PROMPT_UNSPECIFIED\x10\x00\x12\x12\n" +
	"\x0ePROMPT_UNKNOWN\x10\x01\x12\x0f\n" +
	"\vPROMPT_NONE\x10\x02\x12\x10\n" +
	"\fPROMPT_LOGIN\x10\x03\x12\x12\n" +
	"\x0ePROMPT_CONSENT\x10\x04\x12\x19\n" +
	"\x15PROMPT_SELECT_ACCOUNT\x10\x05B'Z%zntr.io/solid/api/oidc/core/v1;corev1b\x06proto3"

var (
	file_oidc_core_v1_enums_proto_rawDescOnce sync.Once
	file_oidc_core_v1_enums_proto_rawDescData []byte
)

func file_oidc_core_v1_enums_proto_rawDescGZIP() []byte {
	file_oidc_core_v1_enums_proto_rawDescOnce.Do(func() {
		file_oidc_core_v1_enums_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_oidc_core_v1_enums_proto_rawDesc), len(file_oidc_core_v1_enums_proto_rawDesc)))
	})
	return file_oidc_core_v1_enums_proto_rawDescData
}

var file_oidc_core_v1_enums_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_oidc_core_v1_enums_proto_goTypes = []any{
...
func file_oidc_core_v1_enums_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_oidc_core_v1_enums_proto_rawDesc), len(file_oidc_core_v1_enums_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
