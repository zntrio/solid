...
// 	protoc        v3.11.4
// source: oidc/discovery/discovery.proto
...
func (x *ServerMetadata) Reset() {
	*x = ServerMetadata{}
	if protoimpl.UnsafeEnabled {
		mi := &file_oidc_discovery_discovery_proto_msgTypes[0]
...
func (*ServerMetadata) Descriptor() ([]byte, []int) {
	return file_oidc_discovery_discovery_proto_rawDescGZIP(), []int{0}
}
...
var File_oidc_discovery_discovery_proto protoreflect.FileDescriptor

var file_oidc_discovery_discovery_proto_rawDesc = []byte{
	...
	0x2e, 0x76, 0x31, 0x22, 0xfb, 0x15, 0x0a, 0x0e, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x4d, 0x65,
	...
	0x64, 0x42, 0x1f, 0x5a, 0x1d, 0x6f, 0x69, 0x64, 0x63, 0x2f, 0x64, 0x69, 0x73, 0x63, 0x6f, 0x76,
	0x65, 0x72, 0x79, 0x2f, 0x76, 0x31, 0x3b, 0x64, 0x69, 0x73, 0x63, 0x6f, 0x76, 0x65, 0x72, 0x79,
	0x76, 0x31, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_oidc_discovery_discovery_proto_rawDescOnce sync.Once
	file_oidc_discovery_discovery_proto_rawDescData = file_oidc_discovery_discovery_proto_rawDesc
)

func file_oidc_discovery_discovery_proto_rawDescGZIP() []byte {
	file_oidc_discovery_discovery_proto_rawDescOnce.Do(func() {
		file_oidc_discovery_discovery_proto_rawDescData = protoimpl.X.CompressGZIP(file_oidc_discovery_discovery_proto_rawDescData)
	})
	return file_oidc_discovery_discovery_proto_rawDescData
}

var file_oidc_discovery_discovery_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_oidc_discovery_discovery_proto_goTypes = []interface{}{
	(*ServerMetadata)(nil), // 0: oidc.discovery.v1.ServerMetadata
}
var file_oidc_discovery_discovery_proto_depIdxs = []int32{
...
func init() { file_oidc_discovery_discovery_proto_init() }
func file_oidc_discovery_discovery_proto_init() {
	if File_oidc_discovery_discovery_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_oidc_discovery_discovery_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_oidc_discovery_discovery_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_oidc_discovery_discovery_proto_goTypes,
		DependencyIndexes: file_oidc_discovery_discovery_proto_depIdxs,
		MessageInfos:      file_oidc_discovery_discovery_proto_msgTypes,
	}.Build()
	File_oidc_discovery_discovery_proto = out.File
	file_oidc_discovery_discovery_proto_rawDesc = nil
	file_oidc_discovery_discovery_proto_goTypes = nil
	file_oidc_discovery_discovery_proto_depIdxs = nil
}
